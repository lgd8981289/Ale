...
function initMitt () {
  ...
  provide('alSubmenu-toggleCollapseSymbol', alSubmenuToggleCollapseSymbol)
  provide('alMenuItem-clickSymbol', alMenuItemClickSymbol)
  provide('alSubmenu-clickSymbol', alSubmenuClickSymbol)
  return {
    alSubmenuToggleCollapseSymbol,
    alMenuItemClickSymbol,
...
$alEmit(this.alSubmenuToggleCollapseSymbol, value);
  ...
  mounted() {
    ...
    $alOn(this.alMenuItemClickSymbol, this.handleItemClick)
    $alOn(this.alSubmenuClickSymbol, this.handleSubmenuClick)
