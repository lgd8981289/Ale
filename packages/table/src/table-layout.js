...
class TableLayout {
  ...
  updateScrollY() {
    ...
    if (this.table.$el && bodyWrapper) {
      const body = bodyWrapper.querySelector('.al-table__body');
  ...
  setHeight(value, prop = 'height') {
    ...
    if (!el && (value || value === 0)) return nextTick().then(() => this.setHeight(value, prop));
  ...
  updateElsHeight() {
    ...
    if (!this.table.$ready) return nextTick().then(() => this.updateElsHeight());
    ...
    const headerTrElm = headerWrapper ? headerWrapper.querySelector('.al-table__header tr') : null;
    ...
    if (
      ...
      return nextTick().then(() => this.updateElsHeight());
    }
