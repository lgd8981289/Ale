...
export default {
  ...
  render(h) {
    ...
    return (
      <table class="al-table__header" cellspacing="0" cellpadding="0" border="0">
        <colgroup>
              ...
              {columns.map((column, cellIndex) => (
                ...
                >
                  ...
                  >
                    ...
                    {column.filterable ? (
                      <span
                        class="al-table__column-filter-trigger"
                        on-click={$event => this.handleFilterClick($event, column)}
                      >
                        <i
                          class={[
                            'al-icon-arrow-down',
                            column.filterOpened ? 'al-icon-arrow-up' : ''
                          ]}
                        ></i>
                      </span>
                    ) : (
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.al-table__column-filter-trigger') || cell;
      ...
      if (!filterPanel) {
        filterPanel = createApp(FilterPanel);
