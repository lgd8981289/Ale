...
import AlSelect from '@components/select';
...
const AlPagination = {
  ...
  render() {
      ...
      <div
        class={[
          'al-pagination',
          {
            ...
            'al-pagination--small': this.small
          }
        ]}
      >
        <template></template>
    ...
    const rightWrapper = <div class="al-pagination__rightwrapper"></div>;
  ...
  components: {
        ...
        return (
          ...
          >
            {this.$parent.prevText ? (
              ...
              <i class="al-icon al-icon-arrow-left"></i>
            )}
          </button>
        );
      }
          ...
          <span class="al-pagination__sizes">
            ...
            >
              {this.pageSizes.map(item => (
                <al-option value={item} label={item + this.t('al.pagination.pagesize')}></al-option>
              ))}
            </al-select>
          </span>
        );
    ...
    Jumper: {
      ...
      render(h) {
        return (
          <span class="al-pagination__jump">
            {this.t('al.pagination.goto')}
            <al-input
            ...
            />
            {this.t('al.pagination.pageClassifier')}
          </span>
        );
      }
    },
