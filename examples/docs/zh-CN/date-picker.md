...
<template>
  <div class="block">
    ...
    <al-date-picker v-model="value1" type="date" placeholder="选择日期"> </al-date-picker>
  </div>
  <div class="block">
...
<div class="container">
  <div class="block">
    ...
    <al-date-picker v-model="value1" type="week" format="yyyy 第 WW 周" placeholder="选择周">
    </al-date-picker>
  </div>
  <div class="block">
    <span class="demonstration">月</span>
    <al-date-picker v-model="value2" type="month" placeholder="选择月"> </al-date-picker>
  </div>
</div>
<div class="container">
  <div class="block">
    <span class="demonstration">年</span>
    <al-date-picker v-model="value3" type="year" placeholder="选择年"> </al-date-picker>
  </div>
  <div class="block">
    <span class="demonstration">多个日期</span>
    <al-date-picker type="dates" v-model="value4" placeholder="选择一个或多个日期">
    </al-date-picker>
  </div>
</div>
