...
```html
<template>
  <al-table v-loading="loading" :data="tableData" style="width: 100%">
...
<template>
  <al-table
    ...
    element-loading-spinner="al-icon-loading"
...
```html
<template>
  <al-button type="primary" @click="openFullScreen1" v-loading.fullscreen.lock="fullscreenLoading">
    指令方式
  </al-button>
  <al-button type="primary" @click="openFullScreen2">
    服务方式
  </al-button>
</template>
