...
<div class="block">
  ...
  <al-pagination layout="prev, pager, next" :total="50"> </al-pagination>
</div>
<div class="block">
...
```html
<al-pagination :page-size="20" :pager-count="11" layout="prev, pager, next" :total="1000">
</al-pagination>
```
...
```html
<al-pagination background layout="prev, pager, next" :total="1000"> </al-pagination>
```
...
```html
<al-pagination small layout="prev, pager, next" :total="50"> </al-pagination>
```
...
```html
<div>
  <al-switch v-model="value"> </al-switch>
  <al-pagination :hide-on-single-page="value" :total="5" layout="prev, pager, next">
  </al-pagination>
</div>
