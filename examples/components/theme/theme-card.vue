        ...
        <div class="info-center">
          <div class="title">
            ...
            <span class="right more" v-else>
              <al-dropdown @command="actionClick">
                <i class="al-icon-more"></i>
                <al-dropdown-menu slot="dropdown">
                  <al-dropdown-item command="rename">{{
                    getActionDisplayName('rename-theme')
                  }}</al-dropdown-item>
                  <al-dropdown-item command="copy">{{
                    getActionDisplayName('copy-theme')
                  }}</al-dropdown-item>
                  <al-dropdown-item command="delete" style="color: #f56c6c">
