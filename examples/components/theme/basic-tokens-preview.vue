...
<template>
  <div class="component-preview">
    ...
    <div class="color">
      <al-row :gutter="12">
        <al-col :span="4" v-for="(color, key) in colorLine" :key="key">
    ...
    <al-row :gutter="12">
      ...
      <al-col :span="9">
        ...
        >
          With MySpace becoming more popular every day, there is the constant need to be different.
          There are millions of users. If MySpace layouts are chosen well, then you can enhance your
          profile a great deal.
        </p>
      </al-col>
      <al-col :span="9">
        ...
        >
          ...
          handhelds and workers in the field stay in touch with the central office via their
          notebooks. Computer hardware weaves itself through the fabric of our lives.
        </p>
      </al-col>
    </al-row>
  </div>
...
<script>
import bus from '@demo/bus';
import { tintColor } from '@demo/color.js';
