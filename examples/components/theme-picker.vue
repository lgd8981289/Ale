...
.theme-picker .al-color-picker__trigger {
  vertical-align: middle;
}

.theme-picker-dropdown .al-color-dropdown__link-btn {
  display: none;
}
</style>
...
export default {
  ...
  watch: {
    theme(val, oldVal) {
      ...
      if (!this.chalk) {
        const url = `https://unpkg.com/ale-ui@${version}/lib/theme-chalk/index.css`;
