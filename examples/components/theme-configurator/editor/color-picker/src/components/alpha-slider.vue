<template>
  <div class="al-color-alpha-slider" :class="{ 'is-vertical': vertical }">
    <div
      class="al-color-alpha-slider__bar"
      @click="handleClick"
      ref="bar"
      :style="{
    ...
    ></div>
    <div
      class="al-color-alpha-slider__thumb"
      ref="thumb"
      :style="{
        left: thumbLeft + 'px',
        top: thumbTop + 'px'
