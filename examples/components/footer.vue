  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-main">
        ...
        <a href="https://github.com/lgd8981289/Ale" class="footer-main-link" target="_blank">{{
      ...
      <div class="footer-main">
        ...
        >
        <a href="https://segmentfault.com/t/ale-ui" class="footer-main-link" target="_blank"
          >SegmentFault</a
        >
        <a
