...
<template>
  <div class="page-changelog">
    <div class="heading">
      <al-button class="fr">
        <a href="https://github.com/lgd8981289/Ale" target="_blank">GitHub Releases</a>
      </al-button>
      更新日志
    </div>
...
export default {
  ...
  mounted() {
    ...
    let fragments = `<li><h3><a href="https://github.com/lgd8981289/Ale/tag/v${release}" target="_blank">${release}</a></h3>`;
    ...
    for (let len = changeLogNodes.length, i = 2; i < len; i++) {
      ...
      if (node.tagName !== 'H3') {
        ...
        fragments += `</li><li><h3><a href="https://github.com/lgd8981289/Ale/tag/v${release}" target="_blank">${release}</a></h3>`;
      }
    }
