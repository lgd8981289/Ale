  ...
  <div>
    ...
    <div class="block">
      ...
      <al-row :gutter="20">
        <al-col :span="9">
          <p>
            Fix the navigation at the left edge, thus improves its visibility, making it easier to
            switch between pages. In this case, the top area of the page holds commonly used tools,
            e.g. search bar, help button, notice button, etc. Suitable for background management or
            utility websites.
          </p>
        </al-col>
        <al-col :span="15" class="nav-demos">
          <img
            ...
            alt="Level 1 categories"
            @click="enlarge(846, $event)"
          />
          <h5>Level 1 categories</h5>
          <p>
            Suitable for simply structured sites with only one level of pages. No breadcrumb is
            needed.
          </p>
          <img
            src="@demo/assets/images/navbar_2.png"
            alt="Level 2 categories"
            @click="enlarge(846, $event)"
          />
          <h5>Level 2 categories</h5>
          <p>
            Sidebar displays up to two levels of navigation. Breadcrumbs are recommended in
            combination of second level navigation, making it easier for the users to locate and
            navigate.
          </p>
          <img
            src="@demo/assets/images/navbar_3.png"
            alt="Level 3 categories"
            @click="enlarge(846, $event)"
          />
