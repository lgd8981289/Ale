...
export declare class AlMessageBoxComponent extends Vue {
  title: string;
  message: string;
  type: MessageType;
  iconClass: string;
...
export interface AlMessageBoxOptions {
  ...
  callback?: (action: MessageBoxCloseAction, instance: AlMessageBoxComponent) => void;

  /** Callback before MessageBox closes, and it will prevent MessageBox from closing */
  beforeClose?: (
    action: MessageBoxCloseAction,
    instance: AlMessageBoxComponent,
    done: () => void
  ) => void;
...
export interface AlMessageBoxShortcutMethod {
  (message: string, title: string, options?: AlMessageBoxOptions): Promise<MessageBoxData>;
  (message: string, options?: AlMessageBoxOptions): Promise<MessageBoxData>;
}

export interface AlMessageBox {
  /** Show a message box */
  (message: string, title?: string, type?: string): Promise<MessageBoxData>;

  /** Show a message box */
  (options: AlMessageBoxOptions): Promise<MessageBoxData>;

  /** Show an alert message box */
  alert: AlMessageBoxShortcutMethod;

  /** Show a confirm message box */
  confirm: AlMessageBoxShortcutMethod;

  /** Show a prompt message box */
  prompt: AlMessageBoxShortcutMethod;

  /** Set default options of message boxes */
  setDefaults(defaults: AlMessageBoxOptions): void;
