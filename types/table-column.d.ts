...
import { AleUIComponent, AleUIHorizontalAlignment } from './component';
...
export declare class AlTableColumn extends AleUIComponent {
  ...
  renderHeader: (h, data: RenderHeaderData) => VNode | string;
  ...
  /** Whether column width can be resized. Works when border of `al-table` is `true` */
  resizable: boolean;
