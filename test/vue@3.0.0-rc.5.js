var Vue = (function (exports) {
  ...
  */
  ...
  const errorMessages = {
    ...
    [37 /* X_V_SLOT_EXTRANEOUS_DEFAULT_SLOT_CHILDREN */]:
  ...
  function validateBrowserExpression(node, context, asParams = false, asRawStatements = false) {
    ...
    try {
      ...
      context.onError(
        createCompilerError(42 /* X_INVALID_EXPRESSION */, node.loc, undefined, message)
      );
    }
  }
      ...
      if (node.children.length > 0) {
        if (vnodeTag === KEEP_ALIVE) {
          ...
          if (node.children.length > 1) {
            context.onError(
              createCompilerError(43 /* X_KEEP_ALIVE_INVALID_CHILDREN */, {
      ...
      if (prop.type === 6 /* ATTRIBUTE */) {
        ...
        if (!arg && (isBind || isOn)) {
          ...
          if (exp) {
            ...
            context.onError(
              createCompilerError(
                isBind ? 32 /* X_V_BIND_NO_EXPRESSION */ : 33 /* X_V_ON_NO_EXPRESSION */,
                loc
              )
            );
          }
  ...
  function processSlotOutlet(node, context) {
    ...
    if (propsWithoutName.length > 0) {
      ...
      if (directives.length) {
        context.onError(
          createCompilerError(
            34 /* X_V_SLOT_UNEXPECTED_DIRECTIVE_ON_SLOT_OUTLET */,
            directives[0].loc
          )
        );
      }
  ...
  const transformModel$1 = (dir, node, context) => {
          ...
          if (type.type === 7 /* DIRECTIVE */) {
            ...
            switch (type.value.content) {
              ...
              case 'file':
                isInvalidType = true;
                context.onError(
                  createDOMCompilerError(54 /* X_V_MODEL_ON_FILE_INPUT_ELEMENT */, dir.loc)
                );
                break;
              default:
                // text type
    ...
    baseResult.props = baseResult.props.filter((p) => {
      if (p.key.type === 4 /* SIMPLE_EXPRESSION */ && p.key.content === 'modelValue') {
        return false;
      }
      return true;
    });
      ...
      if (component === TRANSITION$1) {
        return () => {
          if (node.children.length && hasMultipleChildren(node)) {
            context.onError(
              createDOMCompilerError(57 /* X_TRANSITION_INVALID_CHILDREN */, {
                start: node.children[0].loc.start,
                end: node.children[node.children.length - 1].loc.end,
                source: ''
              })
